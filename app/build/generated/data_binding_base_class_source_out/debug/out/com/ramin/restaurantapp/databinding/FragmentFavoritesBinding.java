...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  private FragmentFavoritesBinding(@NonNull ConstraintLayout rootView, @NonNull TextView message) {
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFavoritesBinding((ConstraintLayout) rootView, message);
    }
