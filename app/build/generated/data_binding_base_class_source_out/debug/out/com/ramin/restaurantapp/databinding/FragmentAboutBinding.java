...
public final class FragmentAboutBinding implements ViewBinding {
  ...
  private FragmentAboutBinding(@NonNull LinearLayout rootView, @NonNull WebView aboutWebView) {
  ...
  public static FragmentAboutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.aboutWebView;
      WebView aboutWebView = ViewBindings.findChildViewById(rootView, id);
      if (aboutWebView == null) {
        break missingId;
      }

      return new FragmentAboutBinding((LinearLayout) rootView, aboutWebView);
    }
